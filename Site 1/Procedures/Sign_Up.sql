...
begin
	...
	union 
	(select player_id from Player_Info@site_link where user_name = input_user_name));
...
exception
	...
	when no_data_found then
		...
		id := id + 1;
		insert into Player_Info (player_id, user_name, display_name, bio, player_level, score) 
